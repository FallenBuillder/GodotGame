...
@onready var tower_name_label = $Panel / TowerNameLabel
@onready var damage_label = $Panel / DamageLabel
@onready var focus_mode_label = $Panel / FocusModeLabel
@onready var prev_focus_button = $Panel /  PrevButton
@onready var next_focus_button = $Panel /  NextButton
